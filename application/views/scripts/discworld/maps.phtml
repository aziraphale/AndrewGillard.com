<article class="dwmaps">
    <? if ($this->requestedMap == 'monks-of-cool') { ?>
        <p class="centre">
            <a href="<?php echo $this->baseUrl() ?>/img/dw/maps/monks-of-cool.png">
                <img src="<?php echo $this->baseUrl() ?>/img/dw/maps/monks-of-cool.png" alt="Map of the Temple of Cool" />
            </a>
        </p>
    ...
    <? } elseif ($this->requestedMap == 'pictsie-barrows') { ?>
        <p class="centre">
            <a href="<?php echo $this->baseUrl() ?>/img/dw/maps/pictsie-barrows.png">
                <img src="<?php echo $this->baseUrl() ?>/img/dw/maps/pictsie-barrows.png" alt="Map of the Pictsie Barrows" />
            </a>
        </p>
    ...
    <? } else { ?>
        ...
        <p>Available maps:</p>
        <ul>
            <li><a href="<?php echo $this->url(array('map'=>'monks-of-cool'), 'dwmap') ?>">Temple of the Monks of Cool</a></li>
            <li><a href="<?php echo $this->url(array('map'=>'pictsie-barrows'), 'dwmap') ?>">Pictsie Barrows</a></li>
        </ul>
    <? } ?>
</article>
