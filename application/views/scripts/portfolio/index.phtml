...
$pfImgUrl = function ($id) use ($baseUrl) {
    return "$baseUrl/img/portfolio/$id.png";
};

$pfThumbUrl = function ($id) use ($baseUrl) {
    return "$baseUrl/img/portfolio/thumbs/$id.jpg";
};

$vcScreen = function ($id) use ($baseUrl) {
    return "$baseUrl/img/portfolio/viper-cart-screens/?file=" . urlencode($id) . ".png";
};

?>

<?php if (Zend_Controller_Front::getInstance()->getParam('bootstrap')->getOption('lookingForWork')): ?>
    <article class="availableforwork">
        <p>I'm currently available for full-time, permanent work as an experienced, Zend Certified, Web Developer. If
            ...
            <a href="<?php echo $this->url(array('controller'=>'cv'), 'default', true) ?>">check out my CV</a>.</p>
    </article>
<?php endif; ?>
...
<section class="portfoliosite personal">
    ...
    <p>In fact, it can be enlightening to view the page with JavaScript disabled (and with one CSS tweak to make the
        ...
        <a href="<?php echo $this->baseUrl() ?>/img/portfolio/furcodegenerator_nojs.png">it becomes clear just how much
...
<section class="portfoliosite personal">
    <h2>
        <a href="<?php echo $this->baseUrl() ?>/gallery-demo/">Simple Image Gallery</a>
    ...
    <p>As part of its display of digital cameras' EXIF data, if there is any <strong>geographical information</strong>
        ...
        <a href="<?php echo $this->baseUrl() ?>/gallery-demo/?file=IMAG0217.jpg">this photograph of a recessed, circular
...
<section class="portfoliosite personal">
    <h2>
        <a href="<?php echo $this->baseUrl() ?>/shopping-list-demo/">Simple Shopping List</a>
        <span class="pfdate">2011-2012</span>
    </h2>
    <ul class="pftech">
        <li>HTML5</li>
...
<section class="portfoliosite cbs">
    <h2>
        <a href="<?php echo $this->baseUrl() ?>/img/portfolio/viper-cart-screens/">Viper Cart</a>
...
<section class="portfoliosite personal">
    <h2>
        <a href="<?php echo $this->baseUrl() ?>/img/portfolio/lorddeathnet-screens/">Lord d'Eath's Stuff</a>
...
<section class="portfoliosite personal">
    <h2>
        <a href="<?php echo $this->baseUrl() ?>/files/Level_3_Project.pdf">My Final Year University Project</a>
    ...
    <p>My <a href="<?php echo $this->baseUrl() ?>/files/Level_3_Project.pdf">final-year project</a> at university
    ...
    <p>This project involved the use of MySQL <strong>stored procedures</strong> for performance reasons, and the PHP
        code included in the appendices of <a href="<?php echo $this->baseUrl() ?>/files/Level_3_Project.pdf">the report
...
<article class="portfoliosite personal">
    ...
    <p>Even though the service has been shut down, the website is still running for historical interest. I also have a
        ...
        <a href="<?php echo $this->url(array('controller'=>'web2messenger'), 'default', true) ?>">Web2Messenger page of
        this site</a>.</p>
</article>
